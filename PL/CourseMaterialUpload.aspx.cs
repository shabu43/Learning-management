...
namespace PL
{
    public partial class CourseMaterialUpload : System.Web.UI.Page
    {
       ...
       protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            foreach (string fileTagName in files)
            {
                ...
                if (file.ContentLength > 0)
                {
                    ...
                    FileUtilities1.SaveFile(name,d, contentType, size, fileData);
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Uploaded');", true);
                }
            }
            int ad = Convert.ToInt32(Request.QueryString["id"]);
            DataTable fileList = FileUtilities1.GetFileList(ad);
