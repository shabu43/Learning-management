<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentSignup.aspx.cs" Inherits="PL.StudentSignup" %>
    ...
    <div>
         <table style="margin-left:50px;margin-top:10px;">
            ...
            <tr>
                ...
                <td>
                    <asp:Button class="button" ID="btnSubmit1" runat="server" OnClick="btnSubmit1_Click" Text="Sign Up" />
                </td>
            </tr>
        </table>
    </div>
