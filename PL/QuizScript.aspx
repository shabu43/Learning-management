<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuizScript.aspx.cs" Inherits="PL.QuizScript" %>
       ...
       <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False"
               ...
               BorderColor="Silver"
                ...
                <Columns>   
                    ...
                    <asp:TemplateField HeaderText="Quiz Script" >
                          ...
                          <ItemTemplate>
                            <table style="width:900px">
                             <tr ""> <td >
                                ...
                                <tr> <td>
                                    <asp:Label ID="Label7" runat="server"  Text='<%# Bind("TeacherAnsLabel") %>' ></asp:Label>
                                    <asp:Label ID="Label6" runat="server"  Text='<%# Bind("studentAns") %>' ></asp:Label>
                              </td></tr>
                                <tr> <td>
                                    <asp:Label ID="Label8" runat="server"  Text='<%# Bind("StudentAnsLabel") %>' ></asp:Label>
                                    <asp:Label ID="Label9" runat="server"  Text='<%# Bind("teacherAns") %>' ></asp:Label>
                              </td></tr>
                         </table>
                        </ItemTemplate>
            ...
            <a href=<%= ResolveUrl("QuizStudentList.aspx") + "?id=" +Request.QueryString["cid"] %>>Back to Student List</a>
    </div>
    </div>
    </form>
     <%-- footer --%>
