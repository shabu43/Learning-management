<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewQuestion.aspx.cs" Inherits="PL.AddNewQuestion" %>
   ...
   <form id="form1" runat="server">
        ...
        <table style="margin-left:50px;margin-top:10px;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQuestion" runat="server" TextMode="MultiLine" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">A :</td>
                <td>
                    <asp:TextBox ID="txtA" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">B :</td>
                <td>
                    <asp:TextBox ID="txtB" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">C :</td>
                <td>
                    <asp:TextBox ID="txtC" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">D :</td>
                <td>
                    <asp:TextBox ID="txtD" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">Ans :</td>
                <td>
                    <asp:TextBox ID="txtAns" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">Question Type :</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button class="button" ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Save" />
                </td>
            </tr>
        </table>
