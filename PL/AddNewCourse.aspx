<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewCourse.aspx.cs" Inherits="PL.AddCourse" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="margin-left:50px;margin-top:10px;">
            ...
            <tr>
                ...
                <td class="auto-style3">Course Code :</td>
                <td>
                    <asp:TextBox ID="txtCourseCode" runat="server"  Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">Course Title :</td>
                <td>
            ...
            <tr>
                <td class="auto-style3">Enroll Key :</td>
                <td>
                    <asp:TextBox TextMode="Password" ID="txtEnrollKey" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
