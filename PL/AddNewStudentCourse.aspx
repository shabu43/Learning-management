<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewStudentCourse.aspx.cs" Inherits="PL.AddNewStudentCourse" %>
  ...
  <li class="dropdown">
    ...
    <div>
            ...
            <tr>
                ...
                <td class="auto-style3">Enter Enrollment Key :</td>
                <td>
                    <asp:TextBox TextMode="Password" ID="txtCourseCode" runat="server"  Width="200px"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Button class="button" ID="btnNotice" runat="server" OnClick="btnNotice_Click" Text="Enroll" />
                </td>
            </tr>
        </table>
    </div>
