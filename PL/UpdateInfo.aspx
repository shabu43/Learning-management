<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateInfo.aspx.cs" Inherits="PL.UpdateInfo" %>
    ...
    <div>
         <table style="margin-left:50px;margin-top:10px;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox Visible="false" ID="txtStudentID" runat="server"  Width="200px"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:Button class="button" ID="btnSubmit1" runat="server" OnClick="btnSubmit1_Click" Text="Update" />
                </td>
            </tr>
        </table>
    </div>
