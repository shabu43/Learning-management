<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignmentUpload.aspx.cs" Inherits="PL.AssignmentUpload" %>
...
<body>
 ...
 <% if (Session["user"] == null && Session["pass"] == null) { %>  <li class="dropdown">
    ...
    <%} %>
     ...
     <asp:Label ID="Label1" margin-left="10px" margin-top="8px" runat="server" BackColor="#ffcc99" Text="Send Assignment " ></asp:Label>
...
<div style="width: 400px; margin-top :40px">
    <div style="clear: both; width: 100%;margin-top:5px">
        ...
        <asp:Button ID="btnUpload" Text="Send" runat="server" 
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server"
                            NavigateUrl='<%# Eval("ID", "DownloadAssignment.aspx?id={0}") %>'
